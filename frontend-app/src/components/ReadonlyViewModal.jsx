...
const ReadOnlyViewModal = ({ application, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded shadow max-w-6xl w-full h-[90vh] overflow-y-auto">
        <h2 className="text-2xl font-bold mb-6 text-center">View Rejected Application</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p><strong>Main Contact:</strong> {main_contact_number}</p>
              <p><strong>Alt Contact:</strong> {alternative_contact_number}</p>
            ...
            <div className="flex justify-between mt-6">
              ...
              <span className="bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm">Rejected</span>
            </div>
          </div>
        </div>
...
export default ReadOnlyViewModal;
